...
$getthreads="SELECT * from forums where parentid='0' AND type='general' order by lastrepliedto DESC";
...
print "<div id='part2'><A href='message.php?id=$getthreads3[post_id]'><font size='4'>$getthreads3[post]</font></a>
	<br>posted by $getthreads3[author]</div>
	<div id='part1'>
<A href='message.php?id=$getthreads3[post_id]'><font size='4px'>$getthreads3[title]</font></a></div>

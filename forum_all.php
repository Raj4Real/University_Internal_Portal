...
print"<div class='yellowbar'>";
	   ...
	   print"<input type='search' placeholder='Search Forums' class='search rounded'></div>";	
...
print "<div id='part2'><A href='forum_message.php?id=$getthreads3[post_id]'><font style='font-size:20px'>$getthreads3[post]</font></a>
...
<A href='forum_message.php?id=$getthreads3[post_id]'><font size='4px'>$getthreads3[title]</font></a></div>
	<div id='part3'>$getthreads3[showtime]<br>Last post by <font style='font-weight:bold'><b>$getthreads3[lastposter]</b></font></div>	
